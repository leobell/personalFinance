...
const ResetPassword = () => {
    ...
    return (
        <div className="relative flex min-h-screen items-center justify-center bg-[#f9f9f7] px-6 dark:bg-[#0d0d0d]">
            <Helmet>
                <title>Reimposta password - Flowly</title>
            </Helmet>
            ...
            <div className="w-full max-w-sm space-y-6 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Reimposta password</h1>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Scegli una nuova password per il tuo account.</p>
                </div>
